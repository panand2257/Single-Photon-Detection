...
if __name__ == '__main__':
    ...
    w_las = 2*np.pi*490e12
    w_up_up = 2*np.pi*470e12 #Hz
    ...
    e_ops = [T(qeye(N_c), qt.ket2dm(up)), T(qeye(N_c), qt.ket2dm(down)), T(c.dag()*c, qeye(Na)), c0.dag()*c0]
    ...
    plt.plot(tlist, me1.expect[3], 'o', color='green', label = 'cavity occupation')
    #plt.plot(tlist, Num, '-', color='green', label = 'N0')
